...
struct Lidar
{
    ...
    void setParam(double setminDistance=0, double setmaxDistance=50, double setresolution=0.2, double setsderr=0.0, double setgroundSlope=0, int setnumLayers=3, double sethorizontalAngleInc=pi/6)
    {
		...
		horizontalAngleInc = sethorizontalAngleInc;
